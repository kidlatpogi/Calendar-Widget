...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  listConfig: () => ipcRenderer.invoke('list-config'),
    onPerformMemoryClean: (cb) => ipcRenderer.on('perform-memory-clean', cb),
    requestMainGC: () => ipcRenderer.invoke('request-main-gc'),
  acceptTerms: () => ipcRenderer.invoke('accept-terms'),
    removeIcal: (url) => ipcRenderer.invoke('remove-ical', url),
